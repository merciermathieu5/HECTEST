...
window.LEGATUS = {
  ...
  etapes:[
    ...
    },
    {
      ...
      revenuApres:true,
      options:[
        { label:"Soutenir la citoyenneté pour tous les hommes libres", effets:{ romanisation:14, stabilite:6, faveur:-3, tresor:10 },
    ...
    },
    {
      ...
      revenuApres:true,
      options:[
        { label:"Mobiliser toutes les forces pour sauver l'Empire", effets:{ stabilite:9, faveur:3, tresor:-40 },
        ...
        { label:"Te replier sur la défense des cités", effets:{ stabilite:3, romanisation:-4, faveur:-3, tresor:-15 },
    ...
    },
    {
      ...
      revenuApres:true,
      options:[
        { label:"Lever de lourds impôts pour financer l'armée", effets:{ tresor:35, stabilite:-10 },
        ...
        { label:"Rogner l'argent de la monnaie", effets:{ tresor:20, stabilite:-6, faveur:-3, romanisation:-2 },
        ...
        { label:"Réduire l'armée pour souffler", effets:{ tresor:10, stabilite:-3, faveur:-6 },
    ...
    },
    {
      ...
      revenuApres:true,
      options:[
        { label:"Partager le pouvoir entre plusieurs chefs (la tétrarchie)", effets:{ stabilite:10, faveur:4, romanisation:-2 },
        ...
        { label:"Hérisser la frontière de forts et de garnisons (le limes)", cout:30, effets:{ stabilite:8, romanisation:1 },
        ...
        { label:"Tout gouverner seul depuis le centre", effets:{ stabilite:-8, faveur:2 },
  ...
  bilans:[
    { si:{ romanisation:80, stabilite:60, faveur:50 }, perso:"empereur", expr:"content", ambiance:"solennel",
    ...
    { si:{ romanisation:50, stabilite:38 }, perso:"empereur", expr:"content", ambiance:"solennel",
    ...
    { si:{ romanisation:30 }, perso:"conseiller", expr:"neutre", ambiance:"jour",
